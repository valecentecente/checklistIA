            ...
            <div className="relative w-full max-w-5xl bg-white dark:bg-surface-dark rounded-xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]" onClick={e => e.stopPropagation()}>
                ...
                <div className="bg-slate-800 text-white p-4 flex justify-between items-center shrink-0">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="bg-orange-500/20 text-orange-400 px-3 py-0.5 rounded-full border border-orange-500/30 flex items-center gap-1.5 animate-fadeIn">
                             <span className="text-[10px] font-black uppercase tracking-widest">Total no Banco</span>
                ...
                <div className="p-3 bg-gray-50 dark:bg-black/40 border-b border-gray-200 dark:border-gray-700 shrink-0">
                    <div className="relative">
                        ...
                        <input 
                            type="text" 
                            placeholder="Buscar no acervo por nome ou tag..." 
                            value={searchTerm} 
                            onChange={(e) => setSearchTerm(e.target.value)} 
                            className="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-surface-dark text-sm font-medium focus:ring-2 focus:ring-primary/50 outline-none" 
                        />
                    </div>
                </div>
                ...
                <div className="flex-1 overflow-y-auto p-4 bg-gray-100 dark:bg-black/20">
                    {isLoading ? (
                        <div className="flex flex-col items-center justify-center py-20 gap-3">
                            ...
                            <p className="text-xs text-gray-500 uppercase font-bold tracking-widest">Sincronizando Banco de Dados...</p>
                        </div>
                                ...
                                >
                                    <div className="aspect-square bg-gray-200 dark:bg-gray-800 relative overflow-hidden">
                                        ...
                                        <div className="absolute top-2 right-2 flex flex-col gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                            <button onClick={(e) => { e.stopPropagation(); handleDelete(recipe.id, recipe.name); }} className="w-8 h-8 bg-red-600 text-white rounded-full flex items-center justify-center shadow-lg hover:bg-red-700 transition-colors"><span className="material-symbols-outlined text-sm">delete</span></button>
                                        </div>
                                    </div>
                                    <div className="p-3">
                                        <h3 className="font-bold text-[10px] text-gray-800 dark:text-gray-200 line-clamp-2 uppercase leading-tight">{recipe.name}</h3>
                                        <p className="text-[9px] text-gray-400 mt-1 uppercase font-bold flex items-center gap-1">
                ...
                <div className="bg-white dark:bg-surface-dark border-t border-gray-200 dark:border-gray-700 p-3 text-center text-[10px] text-gray-500 flex justify-between px-6 shrink-0 font-bold uppercase tracking-widest">
                    ...
                    <span>Progresso do Acervo: <strong>{totalRecipeCount} / 2000</strong></span>
                </div>
            </div>
        </div>
    );
